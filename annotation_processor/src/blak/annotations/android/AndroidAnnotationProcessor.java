...
public class AndroidAnnotationProcessor extends AbstractProcessor {
    ...
    private void processThrowing(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) throws ProcessingException, Exception {
        ...
        ProcessResult processResult = processAnnotations(extractedModel);

        generateSources(processResult);
    }

    private static boolean nothingToDo(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    ...
    private ProcessResult processAnnotations(AnnotationElements validatedModel) throws ProcessingException, Exception {
        ModelProcessor modelProcessor = buildModelProcessor();
